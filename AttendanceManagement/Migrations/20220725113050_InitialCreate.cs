        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HOD = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Departments_Teachers_HOD",
                        column: x => x.HOD,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BatchStudents_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassAttendances_Slots_SlotId",
                        column: x => x.SlotId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlotBatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SlotBatches_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SlotBatches_Slots_SlotId",
                        column: x => x.SlotId,
                        principalTable: "Slots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClassAttendanceId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attendances_ClassAttendances_ClassAttendanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassStudentAttendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassStudentAttendances_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClassStudentAttendances_Attendances_AttendanceId",
                        column: x => x.AttendanceId,
                        principalTable: "Attendances",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClassStudentAttendances_ClassAttendances_ClassId",
                        column: x => x.ClassId,
                        principalTable: "ClassAttendances",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ClassAttendanceId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassAttendances_SlotId",
                table: "ClassAttendances",
                column: "SlotId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassStudentAttendances_AttendanceId",
                table: "ClassStudentAttendances",
                column: "AttendanceId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassStudentAttendances_ClassId",
                table: "ClassStudentAttendances",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassStudentAttendances_StudentId",
                table: "ClassStudentAttendances",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_HOD",
                table: "Departments",
                column: "HOD");

            migrationBuilder.CreateIndex(
                name: "IX_SlotBatches_BatchId",
                table: "SlotBatches",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_SlotBatches_SlotId",
                table: "SlotBatches",
                column: "SlotId");
